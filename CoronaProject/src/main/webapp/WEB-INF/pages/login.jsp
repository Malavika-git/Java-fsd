...
<body style="background:url('./log.jpg');background-size:cover">
    ...
    <h4 style="color:blue;text-align:center">Login Page</h4>
    <div class="container">
    <p style=color:green>${reg1}</p>
    <h5 style=color:red>${li}</h5>
        <f:form modelAttribute="login">
            <table>
             <div class="form-group">
                <p style="color:red">
               <label for="name" style="margin-top: 30px;"><ion-icon name=""></ion-icon>Email:</label>
            ...
            <label><p style="color:gainsboro"> Do not have an account click  </p></label>
