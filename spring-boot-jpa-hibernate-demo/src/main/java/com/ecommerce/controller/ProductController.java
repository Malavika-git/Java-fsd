...
import com.ecommerce.exception.NoProductsWithSuchNameException.NoProductsWithSuchNameException;
...
public class ProductController {
	...
	public String listProductByNameLike(@RequestParam String name, Model model) throws NoProductsWithSuchNameException, ProductSearchException {
		if(name.length()<=1)
