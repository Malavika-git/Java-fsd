...
<body>
<style> .header { text-align: center; margin-bottom: 20px; 
...
<a class="link" href="favorite.jsp">Favorite Crossing</a> <sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/railway" user="root" password="Malavika@19" /> 
 
 
<sql:query dataSource="${snapshot}" var="result"> 
SELECT * FROM adminhome; </sql:query> 
